        ...
        <div class="container py-5 rounded-top-5 bg-white" style="margin-top: -40px;">
            <div class="card border-0">
                <div class="card-body text-start">
                    ...
                    <p>By accessing or using the website and services of Covisor Infotech Pvt Ltd., you agree to be bound by
                    ...
                    <p>All content on this website, including but not limited to text, graphics, logos, images, audio
                        clips, digital downloads, and software, is the property of Covisor Infotech Pvt Ltd. or its content
                    ...
                    <p>Covisor Infotech Pvt Ltd. and its affiliates shall not be liable for any direct, indirect, incidental,
                    ...
                    <p>Our website may contain links to third-party websites or services that are not owned or
                        controlled by Covisor Infotech Pvt Ltd.. We have no control over, and assume no responsibility for,
                        the content, privacy policies, or practices of any third-party websites or services.</p>

                    <h2>6. Indemnification</h2>
                    <p>You agree to indemnify, defend, and hold harmless Covisor Infotech Pvt Ltd., its officers, directors,
                    ...
                    <p>This Legal Warning shall be governed by and construed in accordance with the laws of India. Any
                        ...
                        jurisdiction of the courts located in New Delhi, India.</p>
                    ...
                    <p>Covisor Infotech Pvt Ltd.<br>
                        ...
                        Address : 2nd Floor, Block B1/632, Janakpuri, 110058, Delhi, India</p>
