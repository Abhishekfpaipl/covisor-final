<template>
    <main @mouseover="hover = true" @mouseleave="hover = false">
      <header>
  ...
  *,
  ...
  :root {
    --bg-clr: rgba(80,5,38,1);
    --speed: 300ms;
    --delay: 300ms;
    --f-small: 0.9rem;
  }
  body {
    background: rgb(80,5,38);
    background: linear-gradient(3deg, var(--bg-clr) 0%, rgba(238,13,112,1) 100%);
    display: flex;
